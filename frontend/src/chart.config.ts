...
const transparentGradientLine = (ctx: CanvasRenderingContext2D, chartArea: ChartArea, hexColor: string) => {
...
const transparentGradientBar = (ctx: CanvasRenderingContext2D, chartArea: ChartArea, hexColor: string, horizontal = false) => {
