...
const TRANSLATIONS = {
  en: {
    ...
    tuning:     'Tuning',
    year:       'Year',
    // song field placeholder
    placeholder: {
      authors:    'First Author | Second Author',
      ccli:       'CCLI song number',
      content:    'Songtext with chords',
      choose:     'Choose...',
      note:       'Some notes, e.g. about capo',
  ...
  de: {
    ...
    // song field placeholder
    placeholder: {
      authors:    'Erster Autor | Zweiter Autor',
      ccli:       'CCLI Liednummer',
      content:    'Liedtext mit Akkorden',
      choose:     'Auswählen...',
      note:       'Notizen, z.B. Capodaster',
      publisher:  'Verlags Informationen',
